...
print(fb.read())
# fwb = open("red_apple.png", "wb")
# fwb.write(fb.read())
# fwb.close()
fb.close()
"""
练习：使用w+模式打开一个文件 a.txt,水仙花数 1000内的数字写入文件，回文数 五位数，写入文件，写入时候，分类写入，可以读取出来
"""
wj = open(file="a.txt", mode="w+", encoding="utf-8")
