"""
字典(dict): 使用大括号{}, 容器类型数据, 由键值对(键与值之间使用冒号)构成的单位, 他们用逗号隔开, 形成字典
    {"键1": 值1, "键2": 值2...}
1. 通过字典的键来获取值, 不是通过索引, 字典是无序的
2.设置闰年判断程序.py 字典的键是唯一的不重复的, 不能修改
...
print(dict4)
dict5 = dict(a=1, b=2, c=3, name="李四")
print(dict5)
dict6 = {}
# 赋值添加数据
dict6["hello"] = "jecker"
print(dict6)
# fromkeys(): 可以添加键, 但是没有值, 值为None(没有, 相当于mysql null)
dict7 = {}.fromkeys(["name", "age", "sex"])
print(dict7)
# 2.设置闰年判断程序.py 给字典的赋值添加数据, 修改数据
...
print(dict20)
del dict20
# NameError: name 'dict20' is not defined
# print(dict20)
